...
def loadFoilDescription():
    ...
    foil_1 = {
        "type": "sail",
        "positionInB": np.array([4.66, -10*np.sind(5), -10.62]),
    ...
    foil_2 = {
        ...
        "positionInB": np.array([7.75, 3.2, 2.6 - 0.935]),
        # Paper numbers
        # Real numbers were: [-5+20;3.3;0] * pi/180
        "attitudeInB": np.array([-5 + 20, 3.5, 0]) * np.pi/180,
        "chord": 0.4,
        "span": 2
    }
    ...
    foil_3 = {
        ...
        "positionInB": np.array([7.75, 4.1, 0.935]),
        # Paper numbers
        # Real numbers were: [-5 + 105, 3.5, 0] * pi/180
        "attitudeInB": np.array([-5 + 105, 3.3, 0]) * np.pi/180,
        "chord": 0.4,
        "span": 2
    }
    ...
    foil_4 = {
        ...
        "positionInB": np.array([0.16032, 3.744, 0.96704 + 0.944]),
        # Paper numbers
        # Real numbers were: [-5, 1, 1.4] * pi/180
        "attitudeInB": np.array([-5, 0.9, 1.7]) * np.pi/180,
        "chord": 0.2,
        "span": 1.2
    }
    ...
    foil_5 = {
        ...
        "positionInB": np.array([0.16032, 3.744, 0.96704]),
        # Paper numbers
        # Real numbers were: [-5 + 90, 0, 1.4] * pi/180
        "attitudeInB": np.array([-5 + 90, 0, 1.7]) * np.pi/180,
        "chord": 0.2,
        "span": 2.032
    }
    ...
    foil_6 = {
        ...
        "attitudeInB": np.array([-5, 1.1, 1.7]) * np.pi/180,
        "chord": 0.2,
        "span": 1.2
    }

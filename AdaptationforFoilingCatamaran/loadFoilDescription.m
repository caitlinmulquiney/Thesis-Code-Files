...
foil{3}.attitudeInB = [90;6;0]*pi/180; % Paper numbers
foil{3}.chord = 0.4;
foil{3}.span = 2;

%% rudder + foil on the starboard
foil{4}.type = 'starboard T foil ';
foil{4}.positionInB = [-5.75;3.744;0.96704 + 0.944];
foil{4}.attitudeInB = [0;-4.6;1.6]*pi/180;
foil{4}.chord = 0.2;
foil{4}.span = 1.2;

foil{5}.type = 'starboard rudder';
foil{5}.positionInB = [-5.75;3.744;0.96704];
...
foil{6}.positionInB = [-5.75;-3.744;0.96704 + 0.944];
foil{6}.attitudeInB = [0;-1.6;1.6]*pi/180;
foil{6}.chord = 0.2;
foil{6}.span = 1.2;

foil{7}.type = 'port rudder';
foil{7}.positionInB = [-5.75;-3.744;0.96704];

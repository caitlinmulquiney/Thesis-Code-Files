...
%% sail
foil{1}.type = 'sail';
foil{1}.positionInB = [-1.3;-10*sind(5);-10.62]; 
...
foil{3}.attitudeInB = [85;4.5;0]*pi/180; % Paper numbers
foil{3}.chord = 0.4;
foil{3}.span = 2;
...
foil{4}.attitudeInB = [0;-5.1;1.6]*pi/180; % Paper Numbers
foil{4}.chord = 0.2;
foil{4}.span = 1.2;
...
foil{5}.attitudeInB = [90;0;1.6]*pi/180; % Paper Numbers
foil{5}.chord = 0.2;
foil{5}.span = 2.032;
...
foil{6}.attitudeInB = [0;1.6;1.6]*pi/180; % Paper Numbers
foil{6}.chord = 0.2;
foil{6}.span = 1.2;
...
foil{7}.attitudeInB = [90;0;1.6]*pi/180; % Paper Numbers
foil{7}.chord = 0.2;
foil{7}.span = 2.032;
